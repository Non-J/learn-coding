/**
 * Get the top 5 most wanted list from the API server, then get additional information for each person
 *
 ...
 * 
 * HINT: In the URL for top wanted list, you can set the number to 5. Or you can get 100 then answer only the first 5.
 */

const topListResponse = await fetch("http://most-wanted.fbi.com:3000/top/5");
